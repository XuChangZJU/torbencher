...
@test_api(torch.Tensor.matrixexp)
class TorchTensorMatrixexpTestCase(TorBencherTestCaseBase):
    ...
    def test_matrix_exp_correctness(self):
        ...
        num_of_elements_each_dim = random.randint(2, 5)  # Random number of elements each dimension (minimum 2 for square matrix)
