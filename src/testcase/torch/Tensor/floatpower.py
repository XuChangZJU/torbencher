...
@test_api(torch.Tensor.floatpower)
class TorchTensorFloatpowerTestCase(TorBencherTestCaseBase):
    ...
    base_tensor = torch.randn(input_size)  # Random base tensor
    exponent_tensor = torch.randn(input_size)  # Random exponent tensor
