...
class TorchTensorCholeskyUinverseTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("2.0.0")
    def test_cholesky_inverse_correctness(self):
        dim = random.randint(2,
                             4)  # Random dimension for the square matrix (must be at least 2x2 for Cholesky decomposition)
