...
@test_api(torch.Tensor.takealongdim)
class TorchTensorTakealongdimTestCase(TorBencherTestCaseBase):
    ...
    def test_take_along_dim_correctness(self):
        ...
        indices_size[dim] = random.randint(1, input_size[dim])  # The size of dimension 'dim' should be less or equal than the corresponding size in input tensor
