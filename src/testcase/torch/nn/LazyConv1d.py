...
class TorchLazyConv1dTestCase(TorBencherTestCaseBase):
    ...
    def test_lazyconv1d_correctness(self):
        ...
        lazy_conv1d = torch.nn.LazyConv1d(out_channels, kernel_size, stride=stride, padding=padding)
        result = lazy_conv1d(input_tensor)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_lazyconv1d_large_scale(self):
