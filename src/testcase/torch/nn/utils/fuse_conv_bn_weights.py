...
@test_api(torch.nn.utils.fuse_conv_bn_weights)
class TorchNnUtilsFuseUconvUbnUweightsTestCase(TorBencherTestCaseBase):
    ...
    def test_fuse_conv_bn_weights_correctness(self):
        ...
        fused_conv_w, fused_conv_b = torch.nn.utils.fuse_conv_bn_weights(conv_w, conv_b, bn_rm, bn_rv, bn_eps, bn_w,
                                                                         bn_b)
