...
class HuberLossTestCase(TorBencherTestCaseBase):
    ...
    def test_huber_loss_correctness(self):
        ...
        result = torch.nn.functional.huber_loss(input_data, target, delta, reduction)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_huber_loss_large_scale(self):
