...
class ConvTranspose2dTestCase(TorBencherTestCaseBase):
    ...
    def test_conv_transpose2d_correctness(self):
        ...
        weight = torch.randn(in_channels, out_channels // groups, kernel_size, kernel_size)
        bias = torch.randn(out_channels)
        result = torch.nn.functional.conv_transpose2d(input_data, weight, bias, stride, padding, output_padding, groups)
        return result
