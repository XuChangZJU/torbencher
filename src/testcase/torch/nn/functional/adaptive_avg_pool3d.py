...
class AdaptiveAvgPool3dTestCase(TorBencherTestCaseBase):
    ...
    def test_adaptive_avg_pool3d_correctness(self):
        ...
        result = torch.nn.functional.adaptive_avg_pool3d(input_data, output_size)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_adaptive_avg_pool3d_large_scale(self):
