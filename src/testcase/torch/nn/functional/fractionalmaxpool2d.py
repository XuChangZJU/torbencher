...
@test_api(torch.nn.functional.fractionalmaxpool2d)
class TorchNnFunctionalFractionalmaxpool2dTestCase(TorBencherTestCaseBase):
    ...
    def test_fractional_max_pool2d_correctness(self):
        ...
        output_tensor, output_indices = torch.nn.functional.fractional_max_pool2d(input_tensor, kernel_size, output_size=output_size, return_indices=True)
