...
class LpPool2dTestCase(TorBencherTestCaseBase):
    ...
    def test_lp_pool2d_correctness(self):
        ...
        result = torch.nn.functional.lp_pool2d(input_data, norm_type, kernel_size, stride, padding, ceil_mode)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_lp_pool2d_large_scale(self):
