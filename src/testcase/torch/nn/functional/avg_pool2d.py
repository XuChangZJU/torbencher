...
class AvgPool2dTestCase(TorBencherTestCaseBase):
    ...
    def test_avg_pool2d_correctness(self):
        ...
        result = torch.nn.functional.avg_pool2d(input_data, kernel_size, stride, padding, ceil_mode, count_include_pad)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_avg_pool2d_large_scale(self):
