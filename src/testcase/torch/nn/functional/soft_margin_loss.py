...
class SoftMarginLossTestCase(TorBencherTestCaseBase):
    ...
    def test_soft_margin_loss_correctness(self):
        ...
        result = torch.nn.functional.soft_margin_loss(input_data, target, reduction)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_soft_margin_loss_large_scale(self):
