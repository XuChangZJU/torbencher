...
class FractionalMaxPool2dTestCase(TorBencherTestCaseBase):
    ...
    def test_fractional_max_pool2d_correctness(self):
        ...
        result = torch.nn.functional.fractional_max_pool2d(input_data, kernel_size, output_size)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_fractional_max_pool2d_large_scale(self):
        ...
        kernel_size = (random.randint(10, 50), random.randint(10, 50))
