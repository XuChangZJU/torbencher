...
@test_api(torch.nn.functional.crossentropy)
class TorchNnFunctionalCrossentropyTestCase(TorBencherTestCaseBase):
    ...
    def test_cross_entropy_correctness(self):
        ...
        num_classes = random.randint(1, input_size[-1])  # Number of classes should be less than or equal to the last dimension of input
