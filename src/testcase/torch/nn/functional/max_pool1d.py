...
class MaxPool1dTestCase(TorBencherTestCaseBase):
    ...
    def test_max_pool1d_correctness(self):
        ...
        result = torch.nn.functional.max_pool1d(input_data, kernel_size, stride, padding, dilation, ceil_mode)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_max_pool1d_large_scale(self):
