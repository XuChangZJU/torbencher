...
class TorchLazyBatchNorm2dTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_lazybatchnorm2d_correctness(self):
        ...
        lazy_batch_norm = torch.nn.LazyBatchNorm2d(num_features)
        result = lazy_batch_norm(input_tensor)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_lazybatchnorm2d_large_scale(self):
