...
class TorchSmoothL1LossTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_smoothl1loss_correctness(self):
        ...
        result = smooth_l1_loss(input_tensor, target)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_smoothl1loss_large_scale(self):
