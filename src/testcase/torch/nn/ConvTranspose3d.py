...
class TorchConvTranspose3dTestCase(TorBencherTestCaseBase):
    ...
    def test_convtranspose3d_correctness(self):
        ...
        conv_transpose3d = torch.nn.ConvTranspose3d(in_channels, out_channels, kernel_size, stride=stride, padding=padding)
        result = conv_transpose3d(input_tensor)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_convtranspose3d_large_scale(self):
