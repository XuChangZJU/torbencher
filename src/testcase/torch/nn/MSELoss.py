...
class TorchMSELossTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_mseloss_correctness(self):
        ...
        result = mse_loss(input_tensor, target)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_mseloss_large_scale(self):
