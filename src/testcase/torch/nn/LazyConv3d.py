...
class TorchNnLazyconv3dTestCase(TorBencherTestCaseBase):
    ...
    def test_lazyconv3d_correctness(self):
        ...
        kernel_size = (random.randint(1, 5), random.randint(1, 5), random.randint(1, 5))  # Kernel size in all three dimensions
        ...
        dilation = (random.randint(1, 3), random.randint(1, 3), random.randint(1, 3))  # Dilation factor for each dimension
