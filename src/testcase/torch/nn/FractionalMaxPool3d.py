...
class TorchFractionalMaxPool3dTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_fractionalmaxpool3d_correctness(self):
        ...
        fractional_max_pool = torch.nn.FractionalMaxPool3d(kernel_size, output_size=output_size)
        result = fractional_max_pool(input_tensor)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_fractionalmaxpool3d_large_scale(self):
