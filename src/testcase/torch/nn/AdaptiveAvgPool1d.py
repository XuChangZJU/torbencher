...
class TorchAdaptiveAvgPool1dTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_adaptiveavgpool1d_correctness(self):
        ...
        adaptive_avg_pool = torch.nn.AdaptiveAvgPool1d(output_size)
        result = adaptive_avg_pool(input_tensor)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_adaptiveavgpool1d_large_scale(self):
