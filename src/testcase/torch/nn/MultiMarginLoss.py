...
class TorchMultiMarginLossTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_multimarginloss_correctness(self):
        ...
        result = multi_margin_loss(input_tensor, target)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_multimarginloss_large_scale(self):
