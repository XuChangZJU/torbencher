...
class TorchNnRnnbaseTestCase(TorBencherTestCaseBase):
    ...
    def test_rnnbase_correctness(self):
        ...
        self.assertTrue(output.shape == expected_output_shape, f"Output shape mismatch. Expected {expected_output_shape}, got {output.shape}")
        self.assertTrue(h_n.shape == expected_hn_shape, f"Hidden state shape mismatch. Expected {expected_hn_shape}, got {h_n.shape}")
