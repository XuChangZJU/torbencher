...
class TorchMultiLabelMarginLossTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_multilabelmarginloss_correctness(self):
        ...
        multilabel_margin_loss = torch.nn.MultiLabelMarginLoss()
        result = multilabel_margin_loss(input_tensor, target)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_multilabelmarginloss_large_scale(self):
