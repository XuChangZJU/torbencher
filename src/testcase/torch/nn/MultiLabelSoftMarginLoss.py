...
class TorchMultiLabelSoftMarginLossTestCase(TorBencherTestCaseBase):
    ...
    def test_multilabelsoftmarginloss_correctness(self):
        ...
        multilabel_soft_margin_loss = torch.nn.MultiLabelSoftMarginLoss()
        result = multilabel_soft_margin_loss(input_tensor, target)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_multilabelsoftmarginloss_large_scale(self):
