...
class TorchAdaptiveMaxPool2dTestCase(TorBencherTestCaseBase):
    ...
    def test_adaptivemaxpool2d_correctness(self):
        ...
        adaptive_max_pool = torch.nn.AdaptiveMaxPool2d((output_height, output_width))
        result = adaptive_max_pool(input_tensor)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_adaptivemaxpool2d_large_scale(self):
