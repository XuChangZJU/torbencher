...
@test_api(torch.cudnn_convolution)
class TorchCudnnConvolutionTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_cudnn_convolution_correctness(self):
        ...
        result = torch.cudnn_convolution(input, weight, bias, stride=stride, padding=padding, dilation=dilation, groups=groups)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_cudnn_convolution_large_scale(self):
