...
@test_api(torch.batch_norm_elemt)
class TorchBatchNormElemtTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_batch_norm_elemt_correctness(self):
        ...
        result = torch.batch_norm_elemt(input, running_mean, running_var, weight, bias, eps=eps)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_batch_norm_elemt_large_scale(self):
