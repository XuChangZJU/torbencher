...
class TorchLogicalandTestCase(TorBencherTestCaseBase):
    ...
    input_tensor = torch.randint(0, 2, input_size).bool() # Generates random tensor with 0 or 1, representing False or True
    other_tensor = torch.randint(0, 2, input_size).bool() # Generates random tensor with 0 or 1, representing False or True
