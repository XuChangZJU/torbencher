...
class TorchSparseCscTensorTestCase(TorBencherTestCaseBase):
    ...
    def test_sparse_csc_tensor_correctness(self):
        ...
        result = torch.sparse_csc_tensor(ccol_indices, row_indices, values, (10, 10))
        return result

    @test_api_version.larger_than("1.1.3")
    def test_sparse_csc_tensor_large_scale(self):
        ...
        result = torch.sparse_csc_tensor(ccol_indices, row_indices, values, (1000, 1000))
        return result
