...
class TorchIndexaddTestCase(TorBencherTestCaseBase):
    ...
    source_size[dim] = index_size  # The indexed dimension of the source tensor should match the size of the index tensor

    input_tensor = torch.randn(input_size)
    index_tensor = torch.randint(0, input_size[dim], (index_size,), dtype=torch.int64)  # Index values should be within the bounds of the chosen dimension
