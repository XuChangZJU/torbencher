...
@test_api(torch.batch_norm_backward_elemt)
class TorchBatchNormBackwardElemtTestCase(TorBencherTestCaseBase):
    @test_api_version.larger_than("1.1.3")
    def test_batch_norm_backward_elemt_correctness(self):
        ...
        result = torch.batch_norm_backward_elemt(grad_output, input, running_mean, running_var, weight, bias, eps=eps)
        return result

    @test_api_version.larger_than("1.1.3")
    def test_batch_norm_backward_elemt_large_scale(self):
